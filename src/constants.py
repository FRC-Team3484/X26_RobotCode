...
class FeedTargetSubsystemConstants:
    ...
    FEED_RPM: np.ndarray = np.array([500, 750, 1000, 1250, 1372, 1482, 1713, 1969, 2255, 2571, 2916, 3288, 3685, 4104, 4543, 4999, 5470, 5953, 6447, 6948], np.float32)
    ...
    HUB_RPM: np.ndarray = np.array([1330, 1372, 1482, 1713, 1969, 2255, 2571, 2916, 3288, 3685, 4104, 4543, 4999, 5470, 5953, 6447, 6948], np.float32)
