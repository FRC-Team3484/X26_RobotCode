...
class FeedTargetSubsystemConstants:
    ...
    HUB_DISTANCES: np.ndarray = np.array([7.128, 15.925, 28.063, 43.374, 61.654, 82.672, 106.178, 131.905, 159.585, 188.949, 214.517, 232.143, 250.571, 269.763, 289.674, 310.253, 331.443, 353.188, 375.426], np.float32)
    HUB_FLIGHT_TIME: np.ndarray = np.array([0.296, 0.442, 0.588, 0.732, 0.875, 1.016, 1.154, 1.291, 1.425, 1.556, 1.663, 1.734, 1.806, 1.879, 1.952, 2.025, 2.099, 2.173, 2.247], np.float32)
