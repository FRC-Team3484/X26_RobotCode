...
class FeedTargetSubsystemConstants:
    ...
    FEED_DISTANCES: np.ndarray = np.array([7.128, 15.925, 28.063, 43.374, 61.654, 82.672, 106.178, 131.905, 159.585, 188.949, 214.517, 232.143, 250.571, 269.763, 289.674, 310.253, 331.443, 353.188, 375.426], np.float32)
    FEED_FLIGHT_TIME: np.ndarray = np.array([0.296, 0.442, 0.588, 0.732, 0.875, 1.016, 1.154, 1.291, 1.425, 1.556, 1.663, 1.734, 1.806, 1.879, 1.952, 2.025, 2.099, 2.173, 2.247], np.float32)

    HUB_RPM: np.ndarray = np.array([2000, 2250, 2500, 2750, 3000, 3250, 3500, 3750, 4000, 4250, 4500, 4750, 5000], np.float32)
    HUB_DISTANCES: np.ndarray = np.array([76.954, 105.961, 135.437, 166.036, 192.414, 210.512, 229.383, 248.994, 269.306, 290.27, 311.833, 333.939, 356.53], np.float32)
    HUB_FLIGHT_TIME: np.ndarray = np.array([0.826, 1.024, 1.195, 1.352, 1.475, 1.555, 1.635, 1.715, 1.795, 1.874, 1.953, 2.032, 2.111], np.float32)
